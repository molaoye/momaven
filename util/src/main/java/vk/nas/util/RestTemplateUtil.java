...
public class RestTemplateUtil {
     ...
     *
     */
    public static ResponseEntity postReq(String url, HttpEntity<MultiValueMap<String, String>> request, Class<String> respType) {
        return getRestInstance().postForEntity(url, request, respType);
    }

    /**
     *
     */
    public static ResponseEntity postReq2(String url, MultiValueMap<String, String> param, Class<String> respType) {
        return getRestInstance().postForEntity(url, getHttpEntity(param, false), respType);
    }

    /**
     *
     */
    public static <T> T postReq(String url, MultiValueMap<String, String> param, Class<T> respType) {
